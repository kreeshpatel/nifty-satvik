...
| **2** | **FEATURES** | PIT-safe cross-sectional conviction features from the depth data (F5 earnings-momentum family + new candidates), one code path offline+live, backward-only windows. | **NOW** |

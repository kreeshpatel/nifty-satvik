...
9. 09_category_a_reexamination.md — the closed-verdict re-examination campaign (Find-Its-Home): 5 of 13 Category-A signals placed (delivery→pre-breakout home; low-vol→live-logging at 0.60; PEAD→closed; zoo→closed; USD→closed (real orthogonal signal, long-only sleeve fails 0115)). Feeds §4 — the homes converge on the second book shape. Zero trials, zero new screens spent.

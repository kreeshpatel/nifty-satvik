...
const SECTORS = {
  largecap: {
    ...
    meta: 'Illustrative — the universe Nifty Satvik scans every Saturday',
    pct: '100 names',
...
const FAQ_ITEMS = [
  ...
  },
  {
    ...
    a: 'No. Nifty Satvik does not connect to your broker and does not place orders. You read the plan here and place every order yourself, in whatever broker you already use, then record what you actually filled so the track record reflects your trades rather than ours.',
  },
  {
      ...
      <section className="tp-hero" id="top">
        <div className="alm-wrap">
          ...
          <p className="tp-hero-sub">
            Nifty Satvik re-scores the Nifty 500 every Saturday evening, and re-prices what you
            already hold after each weekday close. You get A-grade signals with an explicit entry,
            stop and target — and you place the orders yourself.
          </p>
          ...
          <div className="tp-trust">
            ...
            <span className="tp-trust-item"><span className="tp-trust-ic kite"><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="#fff" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round"><path d="M4 4v16h16" /><path d="M4 16l5-5 4 4 7-7" /></svg></span><span className="tp-trust-t">Kite Connect market data</span></span>
            <span className="tp-trust-item"><span className="tp-trust-ic"><svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="11" width="18" height="11" rx="2" /><path d="M7 11V7a5 5 0 0 1 10 0v4" /></svg></span><span className="tp-trust-t">You place every order yourself</span></span>
          </div>
        </div>
      </section>
      ...
      <section className="alm-section" id="how">
        <div className="alm-wrap">
          ...
          <div className="tp-steps">
            {[
              ['Scan', 'Every Saturday we refresh point-in-time prices and fundamentals across the full Nifty 500 large- and mid-cap universe and rebuild the book from the weekly close. No lookahead, ever.'],
              ...
              ['Risk-size', 'Each survivor ships as a complete plan — entry, a hard stop, a target, and a size set to a fixed risk budget with a volatility cap — ready for you to place.'],
            ].map(([title, desc], i) => (
          ...
          <div className="alm-ledger">
            ...
            <div className="alm-ledger-rows">
              {[
                ...
                ['Position size', 'Scaled to your account and capped so risk per trade stays bounded. You place the order yourself and record the fill you actually got.'],
          ...
          <div className="alm-access">
            <div className="alm-access-grid">
              {[
                ...
                ['Your account, your orders', 'We never connect to your broker, place an order, or hold your capital. You trade your own account and tell us what filled.',
                ...
                ['Leave anytime', 'Nothing to disconnect, because nothing was connected. Your journal and track-record data stay readable.',
        ...
        <div className="alm-wrap">
          <div className="alm-foot-grid">
            <div className="alm-foot-brand">
              ...
              <p className="alm-foot-tag">AI-graded swing-trading signals for the Nifty 500. Walk-forward validated; you place every order in your own broker.</p>
            </div>
